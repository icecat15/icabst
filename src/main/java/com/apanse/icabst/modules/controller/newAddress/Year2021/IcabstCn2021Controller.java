...
@Controller
@RequestMapping("/cn")
public class IcabstCn2021Controller {
    ...
    public String welcome() {
        return "/page/2021/cn/index.html";
    }
    ...
    public String about() {
        return "/page/2021/cn/about.html";
    }

    @RequestMapping("/organization")
    public String organization() {
        return "/page/2021/cn/organization.html";
    }

    @RequestMapping("/speakers")
    public String speakers() {
        return "/page/2021/cn/speakers.html";
    }

    @RequestMapping("/program")
    public String program() {
        return "/page/2021/cn/program.html";
    }

    @RequestMapping("/cfp")
    public String cfp() {
        return "/page/2021/cn/cfp.html";
    }

    @RequestMapping("/registration")
    public String registration() {
        return "/page/2021/cn/registration.html";
    }

    @RequestMapping("/venue")
    public String venue() {
        return "/page/2021/cn/venue.html";
    }

    @RequestMapping("/submit")
    public String submit() {
        return "/page/2021/cn/submit.html";
    }

    @RequestMapping("/article")
    public String article() {
        return "/page/2021/cn/article.html";
    }

    @RequestMapping("/sci1")
    public String sci1() {
        return "/page/2021/cn/sci1.html";
    }

    @RequestMapping("/sci2")
    public String sci2() {
        return "/page/2021/cn/sci2.html";
    }

    @RequestMapping("/sci3")
    public String sci3() {
        return "/page/2021/cn/sci3.html";
    }

    @RequestMapping("/sciabstract")
    public String sciabstract() {
        return "/page/2021/cn/sciabstract.html";
    }

    @RequestMapping("/cpci")
    public String cpci() {
        return "/page/2021/cn/cpci.html";
    }

    @RequestMapping("/achieve")
    public String achieve() {
        return "/page/2021/cn/achieve.html";
    }

    @RequestMapping("/proposal")
    public String proposal() {
        return "/page/2021/cn/proposal.html";
    }
